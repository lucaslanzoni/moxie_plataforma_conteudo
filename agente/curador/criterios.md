...
- **Produto de impacto** (hook visual do produto, Topo) vs **Abertura de carrinho** (anúncio de que a coleção está no ar, Fundo): se a legenda diz "disponível no site / no ar / link na bio", é Abertura de carrinho.
